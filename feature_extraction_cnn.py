...
base_dir=r'D:/Project/Thermal FER/thermal images'
...
# checkpoint =tf.keras.callbacks.ModelCheckpoint(filepath="Thermal_FER_1.h5", 
...
model = load_model('Thermal_FER_1.h5')
...
fileList = createFileList('D:/Project/Thermal FER/thermal images/surprised','.png','.jpg')
label= 7
...
# with open("Thermal_image_feature_1.csv", 'a', newline='') as f:
#         writer = csv.writer(f)
...
dataframe= pd.read_csv("./Thermal_image_feature_1.csv")
dataframe.head()